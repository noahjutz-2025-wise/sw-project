...
public class TMDBService {
    ...
    public List<Movie> getPopularMovies() {
        return Objects.requireNonNull(
                        this.restClient
                                .get()
                                .uri("/movie/popular?include_adult=false&include_video=false&page=1&sort_by=popularity.desc&certification_country=US&certification.lte=PG&api_key=" + apiKey)
                                .retrieve()
    ...
    public List<Movie> getMoviesByMood(String mood) {
        ...
        TMDBApiResponse tmdbApiResponse = this.restClient
                .get()
                .uri("/discover/movie?include_adult=false&include_video=false&page=1&sort_by=popularity.desc&certification_country=US&certification.lte=PG-13&with_genres=" + genreParam + "&api_key=" + apiKey)
                .retrieve()
                .body(TMDBApiResponse.class);
